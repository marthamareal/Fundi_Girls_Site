                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse cl-effect-13" id="bs-example-navbar-collapse-1">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="${createLink(controller: 'blog',action: 'show')}" >Blog</a></li>
    ...
    <div class="container">
        ...
        <div class="about-main">
            <div class="col-md-4 about-grids" data-aos="zoom-in">
                ...
                <h3 class="subheading-agileits-w3layouts">Our Mission</h3>
            ...
            <div class="col-md-4 about-grids" data-aos="zoom-in">
                ...
                <h3 class="subheading-agileits-w3layouts">Our Vission</h3>
                <p class="para-agileits-w3layouts">Duis sit amet nisi quis leo fermentum vestibulum vitae eget augue. Sed feugiat quam nec mauris mattis malesuada.</p>
            </div>
            <div class="col-md-4 about-grids" data-aos="zoom-in">
                <i class="fa fa-money" aria-hidden="true"></i>
                <h3 class="subheading-agileits-w3layouts">About Fundi Bots</h3>
                <p class="para-agileits-w3layouts">Duis sit amet nisi quis leo fermentum vestibulum vitae eget augue. Sed feugiat quam nec mauris mattis malesuada.</p>
            </div>
            <div class="clearfix"> </div>
        </div>
...
<!-- //clients-slider-script -->
<!-- /circle-->
<asset:javascript src="circles.js"/>
<script>
    var colors = [
