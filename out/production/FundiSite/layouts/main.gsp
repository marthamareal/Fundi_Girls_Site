...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, Sony Ericsson, Motorola web design" />
    ...
    <asset:stylesheet src="circles.css"/>
                ...
                <div class="container">
                    <nav class="navbar navbar-default">
                        <div class="navbar-header">
                            ...
                            <h1><a  href="index.html">Smart Career</a></h1>
                        </div>
                        <!-- navbar-header -->
                        <div class="collapse navbar-collapse cl-effect-13" id="bs-example-navbar-collapse-1">

                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="main.gsp" class="active scroll">Home</a></li>
            ...
            <div class="modal-header">
                ...
                <div class="signin-form profile">
                    ...
                    <div class="login-form">
                        ...
                        <g:form resource="${this.studentRegister}" method="POST">
                            <fieldset class="form">
                                <f:all bean="studentRegister"/>
                            </fieldset>
...
<div class="services-agileits" id="services">
    <div class="container">
        ...
        <div class="services-agileits-w3layouts">
            ...
            <asset:image src="services1.png" class="img-responsive" data-aos="slide-up" alt=""/>
            <div class="clearfix"> </div>
        </div>
    </div>
</div>
    ...
    <div class="agile_team_grids">
        <div class="col-md-3 agile_team_grid" data-aos="zoom-in">
            <div class="view view-sixth">
                <asset:image src="t1.jpg" alt=" " class="img-responsive"/>
                <div class="mask">
                    <h5>Agnese brent</h5>
        ...
        <div class="col-md-3 agile_team_grid" data-aos="zoom-in">
            <div class="view view-sixth">
                <asset:image src="t2.jpg" alt=" " class="img-responsive"/>
                <div class="mask">
                    <h5>Richard Walsh</h5>
                    <p>Quis autem vel eum iure reprehenderit qui in ea voluptate velit.</p>
                    <div class="w3l-social">
        ...
        <div class="col-md-3 agile_team_grid" data-aos="zoom-in">
            <div class="view view-sixth">
                <asset:image src="t3.jpg" alt=" " class="img-responsive"/>
                <div class="mask">
                    <h5>Lisa ortiz</h5>
                    <p>Quis autem vel eum iure reprehenderit qui in ea voluptate velit.</p>
                    <div class="w3l-social">
        ...
        <div class="col-md-3 agile_team_grid" data-aos="zoom-in">
            <div class="view view-sixth">
                <asset:image src="t4.jpg" alt=" " class="img-responsive"/>
                <div class="mask">
                    <h5>Scott flores</h5>
                    <p>Quis autem vel eum iure reprehenderit qui in ea voluptate velit.</p>
                    <div class="w3l-social">
...
<div class="gallery" id="gallery">
    ...
    <div class="w3layouts-grids gal-wthree-agileits">
        <div id="jzBox" class="jzBox">
            ...
            <asset:image src="#" id="jzBoxTargetImg" alt=""/>
            <div id="jzBoxBottom">
            ...
            <div class="col-md-3 gallery-grid">
                <div class="wpf-demo-4">
                    <a href="images/g1.jpg" class="jzBoxLink item-hover" title="financial Business">
                        <asset:image src="g1.jpg" alt=" " class="img-responsive" />
            ...
            <div class="col-md-3 gallery-grid">
                <div class="wpf-demo-4">
                    <a href="images/g2.jpg" class="jzBoxLink item-hover" title="financial Business">
                        <asset:image src="g2.jpg" alt=" " class="img-responsive" />
                        <div class="view-caption">
                            <p>Full View</p>
                        </div>
                    </a>
            ...
            <div class="col-md-3 gallery-grid">
                <div class="wpf-demo-4">
                    <a href="images/g3.jpg" class="jzBoxLink item-hover" title="financial Business">
                        <asset:image src="g3.jpg" alt=" " class="img-responsive" />
                        <div class="view-caption">
                            <p>Full View</p>
                        </div>
                    </a>
            ...
            <div class="col-md-3 gallery-grid">
                <div class="wpf-demo-4">
                    <a href="images/g4.jpg" class="jzBoxLink item-hover" title="financial Business">
                        <asset:image src="g4.jpg" alt=" " class="img-responsive" />
                        <div class="view-caption">
                            <p>Full View</p>
                        </div>
                    </a>
            ...
            <div class="col-md-3 gallery-grid">
                <div class="wpf-demo-4">
                    <a href="images/g5.jpg" class="jzBoxLink item-hover" title="financial Business">
                        <asset:image src="g5.jpg" alt=" " class="img-responsive" />
                        <div class="view-caption">
                            <p>Full View</p>
                        </div>
                    </a>
            ...
            <div class="col-md-3 gallery-grid">
                <div class="wpf-demo-4">
                    <a href="images/g6.jpg" class="jzBoxLink item-hover" title="financial Business">
                        <asset:image src="g6.jpg" alt=" " class="img-responsive" />
                        <div class="view-caption">
                            <p>Full View</p>
                        </div>
                    </a>
            ...
            <div class="col-md-3 gallery-grid">
                <div class="wpf-demo-4">
                    <a href="images/g7.jpg" class="jzBoxLink item-hover" title="financial Business">
                        <asset:image src="g7.jpg" alt=" " class="img-responsive" />
                        <div class="view-caption">
                            <p>Full View</p>
                        </div>
                    </a>
            ...
            <div class="col-md-3 gallery-grid">
                <div class="wpf-demo-4">
                    <a href="images/g8.jpg" class="jzBoxLink item-hover" title="financial Business">
                        <asset:image src="g8.jpg" alt=" " class="img-responsive" />
                        <div class="view-caption">
                            <p>Full View</p>
                        </div>
                    </a>
...
<div class="contact" id="contact">
    <div class="container">
        ...
        <!--footer-->
        <div class="copy">
            <p>© 2017 Smart Career . All Rights Reserved | Design by <a href="http://w3layouts.com/">W3layouts</a> </p>
        </div>
        <!--/footer -->
    </div>
</div>
...
<!-- js -->
<asset:javascript type="text/javascript" src="jquery-2.1.4.min.js"/>
<!--search-bar-->
...
<asset:javascript src="slideshow.min.js"/>
<asset:javascript src="launcher.js"/>
<!-- //clients-slider-script -->
<!-- /circle-->
<asset:javascript type="text/javascript" src="circles.js"/>
<script>
    var colors = [
...
<asset:javascript src="jzBox.js"/>
<!-- start-smoth-scrolling -->
<asset:javascript type="text/javascript" src="move-top.js"/>
<asset:javascript type="text/javascript" src="easing.js"/>
<script type="text/javascript">
...
<asset:javascript src="aosindex.js"/>
<!-- //Animation-effect -->
